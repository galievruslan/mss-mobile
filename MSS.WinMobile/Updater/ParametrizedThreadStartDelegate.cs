...
namespace Updater {
    internal class ParametrizedThreadStartDelegate : IObservable, IObserver {
        ...
        protected virtual void InvokeStatusUpdate(string status) {
            OnStatusUpdate handler = StatusUpdate;
        ...
        protected virtual void InvokeUpdateComplete() {
