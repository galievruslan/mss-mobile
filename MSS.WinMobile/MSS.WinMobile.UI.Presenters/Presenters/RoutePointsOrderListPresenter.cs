...
{
    public class RoutePointsOrderListPresenter : IListPresenter<OrderViewModel> {
        private static readonly ILog Log = LogManager.GetLogger(typeof(RoutePointsOrderListPresenter));

        private readonly IRoutePointsOrderListView _view;
        private readonly IRepositoryFactory _repositoryFactory;
        private readonly IUnitOfWorkFactory _unitOfWorkFactory;
        private readonly INavigator _navigator;
        private readonly RoutePointViewModel _routePointViewModel;

        private readonly RoutePointsOrderRetriever _retriever;
        private readonly Cache<Order> _cache;

        public RoutePointsOrderListPresenter(IRoutePointsOrderListView view, 
            ...
            RoutePointViewModel routePointViewModel)
        {
            ...
            _retriever = new RoutePointsOrderRetriever(routePoint);
        ...
        public void EditOrder() {
            if (SelectedModel != null) {
                if (SelectedModel.Synchronized)
                    _navigator.GoToViewRoutePointsOrder(_routePointViewModel, SelectedModel);
                else
