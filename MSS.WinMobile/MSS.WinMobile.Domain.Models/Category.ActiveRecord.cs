...
namespace MSS.WinMobile.Domain.Models
{
    ...
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(Category));
        ...
        protected override string SaveCommand
        {
            get
            {
                ...
                return string.Format(_saveCommandTemplate, Id, Name.Replace("'", "''"), ParentId != null ? ParentId.ToString() : "NULL");
            }
        }
