...
{
    public class PriceListMap : ObjectMap<PriceList>
    {
        public PriceListMap()
        {
            Table = new Table("PriceLists")
                .AddColumn(new KeyColumn("Id"))
                .AddColumn(new Column("Name"));
        }

        private string _saveFor;
        public override string SaveFor(PriceList @object)
        {
        ...
        public override string DeleteFor(PriceList @object)
        {
