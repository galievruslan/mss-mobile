...
{
    public class UnitOfMeasureMap : ObjectMap<UnitOfMeasure>
    {
        public UnitOfMeasureMap()
        {
            Table = new Table("UnitsOfMeasure")
                .AddColumn(new KeyColumn("Id"))
                .AddColumn(new Column("Name"));
        }

        private string _saveFor;
        public override string SaveFor(UnitOfMeasure @object)
        {
        ...
        public override string DeleteFor(UnitOfMeasure @object)
        {
