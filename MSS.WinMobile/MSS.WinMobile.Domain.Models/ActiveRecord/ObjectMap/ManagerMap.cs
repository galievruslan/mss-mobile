...
{
    public class ManagerMap : ObjectMap<Manager>
    {
        public ManagerMap()
        {
            Table = new Table("Managers")
                .AddColumn(new KeyColumn("Id"))
                .AddColumn(new Column("Name"));
        }

        private string _saveFor;
        public override string SaveFor(Manager @object)
        {
        ...
        public override string DeleteFor(Manager @object)
        {
