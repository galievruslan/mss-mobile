...
{
    public class ProductSQLiteRepository : SQLiteRepository<Product>
    {
        public ProductSQLiteRepository(IConnectionFactory<SQLiteConnection> connectionFactory, SQLiteUnitOfWork unitOfWork)
