...
namespace MSS.WinMobile.Infrastructure.SqliteRepositoties
{
    public class OrderRepository : Repository<Order>
    {
        ...
        {
            return new OrderQueryObject(new OrderTranslator());
        }

        private const string SaveQueryTemplate =
            "INSERT OR REPLACE INTO Orders (Id, OrderDate, ShippingDate, Manager_Id, ShippingAddress_Id, PriceList_Id, Warehouse_Id, OrderStatus, Note) VALUES ({0}, '{1}', '{2}', {3}, {4}, {5}, {6}, {7}, '{8}')";
